...
The `deserve functioner database` is part of the [`deserve`](https://github.com/plurid/deserve) software.


`deserve functioner database` provides database access to `deserve functions`.
