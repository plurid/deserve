...
The `deserve functioner event` is part of the [`deserve`](https://github.com/plurid/deserve) software.


`deserve functioner event` provides event access to `deserve functions`.
